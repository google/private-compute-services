...
interface SubZeroTemplateHandlerModule {

  @Binds
  @IntoMap
  @TemplateKey(DelegatedUiTemplateType.TEMPLATE_TYPE_SUBZERO_REMINDERS_TILE)
  fun provideTemplateHandler(impl: SubZeroRemindersTileTemplateRenderer): TemplateRenderer
}
