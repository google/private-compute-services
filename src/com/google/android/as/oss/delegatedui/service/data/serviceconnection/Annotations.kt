...
object Annotations {
  @Qualifier @Retention(AnnotationRetention.RUNTIME) annotation class DelegatedUiDataService

  @MapKey annotation class DelegatedUiDataProviderKey(val value: DelegatedUiDataProvider)
}
