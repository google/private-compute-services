...
interface AirFlowTemplaterHandlerModule {

  @Binds
  @IntoMap
  @TemplateKey(DelegatedUiTemplateType.TEMPLATE_TYPE_AIRFLOW)
  fun provideComposeTemplateHandler(impl: AirFlowTemplateRenderer): TemplateRenderer
}
