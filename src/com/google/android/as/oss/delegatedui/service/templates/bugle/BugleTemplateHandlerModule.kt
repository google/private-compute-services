...
interface BugleTemplateHandlerModule {

  @Binds
  @IntoMap
  @TemplateKey(DelegatedUiTemplateType.TEMPLATE_TYPE_BUGLE)
  fun provideTemplateHandler(impl: BugleTemplateRenderer): TemplateRenderer
}
