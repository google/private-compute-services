...
interface BeaconTemplateHandlerModule {

  @Binds
  @IntoMap
  @TemplateKey(DelegatedUiTemplateType.TEMPLATE_TYPE_BEACON)
  fun provideTemplateHandler(impl: BeaconTemplateRenderer): TemplateRenderer
}
