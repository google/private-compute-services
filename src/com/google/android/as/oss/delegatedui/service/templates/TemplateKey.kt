...
/** Provides a map key for the template type, which renderers can use to map their impls to. */
@MapKey annotation class TemplateKey(val value: DelegatedUiTemplateType)
