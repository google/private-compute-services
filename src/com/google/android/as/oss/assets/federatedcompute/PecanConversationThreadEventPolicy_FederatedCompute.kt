...
/** Data policy. */
val PecanConversationThreadEventPolicy_FederatedCompute =
  flavoredPolicies(
    name = "PecanConversationThreadEventPolicy_FederatedCompute",
    ...
    target(PECAN_CONVERSATION_THREAD_EVENT_GENERATED_DTD, Duration.ofDays(7)) {
