...
/** Data policy. */
val PecanMessageEventPolicy_FederatedCompute =
  flavoredPolicies(
    name = "PecanMessageEventPolicy_FederatedCompute",
    ...
    target(PECAN_MESSAGE_EVENT_GENERATED_DTD, Duration.ofDays(7)) {
      ...
      "messageType" { rawUsage(UsageType.ANY) }
      "isNew" { rawUsage(UsageType.ANY) }
      "timestamp" {
