...
public final class InAppTrainerOptions extends BaseOptions {
  ...
  private static boolean isValidAttestationMode(@AttestationMode int attestationMode) {
    return switch (attestationMode) {
      case AttestationMode.DEFAULT, AttestationMode.NONE -> true;
      default -> false;
    };
  }
  ...
  public boolean equals(Object otherObj) {
    ...
    return Objects.equals(sessionName, otherOptions.sessionName)
        && Objects.equals(jobSchedulerJobId, otherOptions.jobSchedulerJobId)
        && Objects.equals(
            allowFallbackToAutoGeneratedJobId, otherOptions.allowFallbackToAutoGeneratedJobId)
        && Objects.equals(federatedPopulationName, otherOptions.federatedPopulationName)
        && attestationMode == otherOptions.attestationMode
        && Objects.equals(personalizationPlan, otherOptions.personalizationPlan)
        && Objects.equals(initialParams, otherOptions.initialParams)
        && Objects.equals(outputDirectory, otherOptions.outputDirectory)
        && Objects.equals(trainingConstraints, otherOptions.trainingConstraints)
        && overrideDeadlineMillis == otherOptions.overrideDeadlineMillis
        && Objects.equals(trainingInterval, otherOptions.trainingInterval)
        && Arrays.equals(contextData, otherOptions.contextData)
        && Objects.equals(inputDirectory, otherOptions.inputDirectory);
  }
