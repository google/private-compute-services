...
/** Module that provides ConfigReader for enabling PCS attestation measurement. */
@Module
@InstallIn(SingletonComponent.class)
interface PcsAttestationMeasurementConfigModule {
  @Provides
  static ConfigReader<PcsAttestationMeasurementConfig> provideConfigReader(
      FlagManagerFactory flagManagerFactory, @GeneralExecutorQualifier Executor executor) {
    return PcsAttestationMeasurementConfigReader.create(
