...
@Entity
data class BsaTokenEntity(
  @ColumnInfo(typeAffinity = TEXT) val tokenParams: BsaTokenParams<*>,
  @ColumnInfo(typeAffinity = TEXT) val encryptedTokenData: EncryptedBsaTokenBytes,
  @ColumnInfo(typeAffinity = INTEGER) val expiration: Instant,
