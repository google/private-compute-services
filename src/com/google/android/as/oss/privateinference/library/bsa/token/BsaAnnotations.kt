...
/** Annotations for [BsaToken] types. */
object BsaAnnotations {

  /** Qualifier for [ProxyToken] token fetch error log mapper. */
  @Qualifier @Retention(AnnotationRetention.RUNTIME) annotation class ProxyTokenErrorLogMapper
