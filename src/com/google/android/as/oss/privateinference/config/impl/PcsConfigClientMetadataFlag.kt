...
/** Use PCS PrivateInferenceConfig to control client metadata sending. */
class PcsConfigClientMetadataFlag
@Inject
internal constructor(val config: ConfigReader<PrivateInferenceConfig>) : ClientMetadataFlag {
  override fun enabled(): Boolean {
    return config.config.sendClientMetadata()
  }
}
