...
/** Injects Tink-based {@link EncryptionHelper} implementation. */
@Module
@InstallIn(SingletonComponent.class)
interface TinkEncryptionHelperModule {
  @Binds
  EncryptionHelperFactory bindFactory(TinkEncryptionHelperFactory factory);
}
