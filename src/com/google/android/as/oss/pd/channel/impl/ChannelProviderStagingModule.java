...
/** Registers a {@link ChannelProvider} for staging using a predefined map of host names. */
@Module
@InstallIn(SingletonComponent.class)
abstract class ChannelProviderStagingModule {

  private static final ImmutableMap<Client, String> HOST_NAMES =
      ImmutableMap.of(
          Client.SUSPICIOUS_MESSAGE_ALERTS, "staging-ondevicesafety-pa.sandbox.googleapis.com",
          Client.PLAY_PROTECT_SERVICE, "staging-ondevicesafety-pa.sandbox.googleapis.com");
