...
interface PlaceHolderCardRendererModule {
  @Binds
  @IntoMap
  @CardTypeKey(CardType.PLACEHOLDER)
  fun bindRenderer(impl: PlaceHolderCardRenderer): CardRenderer<out DeprecatedUiCardContext>
}
