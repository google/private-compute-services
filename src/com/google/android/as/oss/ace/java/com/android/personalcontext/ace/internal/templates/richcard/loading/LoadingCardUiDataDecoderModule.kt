...
/** Dagger module for binding [LoadingCardUiDataDecoder]. */
@Module
@InstallIn(SingletonComponent::class)
interface LoadingCardUiDataDecoderModule {

  /** Binds [LoadingCardUiDataDecoder] into the card decoders map. */
  @Binds
  @IntoMap
  @CardTypeKey(CardType.LOADING)
  fun bindLoadingCardUiDataDecoder(
    decoder: LoadingCardUiDataDecoder
