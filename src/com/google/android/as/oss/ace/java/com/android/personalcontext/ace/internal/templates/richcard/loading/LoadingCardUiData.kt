...
/** Represents the structured UI data for a Loading card. */
data object LoadingCardUiData : DeprecatedUiCardContext {
  override val cardType: CardType = CardType.LOADING
}
