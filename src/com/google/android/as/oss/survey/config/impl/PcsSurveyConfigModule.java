...
/** Module that provides ConfigReader for survey feature. */
@Module
@InstallIn(SingletonComponent.class)
interface PcsSurveyConfigModule {
  @Provides
  static ConfigReader<PcsSurveyConfig> provideConfigReader(
      FlagManagerFactory flagManagerFactory, @GeneralExecutorQualifier Executor executor) {
    return PcsSurveyConfigReader.create(
