...
public abstract class ExecutorAnnotations {
  ...
  /** Annotation to bind {@link Executor} used for Attestation measurement jobs. */
  @Qualifier
  @Retention(RetentionPolicy.RUNTIME)
  public @interface AttestationExecutorQualifier {}

  /** Annotation to bind {@link Executor} used for virtual machine jobs. */
  @Qualifier
  @Retention(RetentionPolicy.RUNTIME)
